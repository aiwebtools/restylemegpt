...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen pt-32 pb-24 flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className={`relative transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <a 
              ...
              className="block relative z-10 w-full aspect-video rounded-2xl overflow-hidden glass-card hover:scale-105 transition-all duration-500 divine-glow"
            >
              <img 
